                ...
                <Container fluid={true} className="text-center footerSection">
                    <Row>
                        ...
                        <Col lg={3} md={6} sm={12} className="p-5 text-justify">
                            ...
                            <p className="serviceDescription" > <FontAwesomeIcon  icon={faEnvelope} /> bappy0bhuiyan@.com</p>
                            <p className="serviceDescription" > <FontAwesomeIcon  icon={faPhone} /> +8801676217559</p>
                        </Col>
                        <Col lg={3} md={6} sm={12} className="p-5 text-justify">
